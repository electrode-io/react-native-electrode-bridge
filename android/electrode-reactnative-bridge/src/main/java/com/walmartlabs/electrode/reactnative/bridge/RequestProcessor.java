...
public class RequestProcessor<TReq, TResp> {
    ...
    public void execute() {
        ...
        Bundle data = BridgeArguments.generateBundle(requestPayload, BridgeMessage.Type.REQUEST);
        ...
        ElectrodeBridgeHolder.sendRequest(req, new ElectrodeBridgeResponseListener<Bundle>() {
            ...
            public void onSuccess(@Nullable Bundle responseData) {
                TResp response = BridgeArguments.generateObject(responseData, responseClass, BridgeMessage.Type.RESPONSE);
